...
import NewSupporter from "./components/newsupporter/newsupporter"
        ...
        <div className="App">
          ...
          <div className={styles.mainBodyDiv}>
            <Switch>
              ...
              <Route exact path="/newsupporter" render={(props) => (
                <NewSupporter {...props} handleSignup={this.handleSignupSubmit} />)} />  {/* handleSignUp passed down to the login, to get the inputed info*/}
              {(this.state.loggedIn) ? (
